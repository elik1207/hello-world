...
- 📊 **Financial Dashboard**: Live tracking of your "Trapped Value" (active funds) and "Lost Value" (expired funds). Expiring soon cards (7/14/30 days) instantly filter the wallet while actively summarizing both their item count and total monetary value.
